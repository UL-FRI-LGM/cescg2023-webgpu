...
export class Workshop extends Sample {
    ...
    render() {
        ...
        // Task 4.4: encode the deferred shading pass
    ...
    async #initResources() {
        ...
        this.renderTexture = this.device.createTexture({
            ...
            // Task 4.4: use a texture format that supports the storage binding usage (e.g., rgba8unorm)
            format: 'rgba8unorm',
            // Task 4.4: replace RENDER_ATTACHMENT with STORAGE_BINDING
    ...
    async #initPipelines() {
        ...
        await this.#initDeferredShadingPipeline();
    ...
    async #initRenderToTexturePipeline() {
        ...
        const bindGroupLayout = this.device.createBindGroupLayout({
            entries: [
                ...
                {
                    binding: 0,
                    // Task 4.4: make the uniform buffer only visible in the vertex stage
                ...
                // Task 4.4: remove the light source buffer from the bind group layout
            ]
        });
        ...
        const createGBufferPipelineDescriptorBase = {
            ...
            fragment: {
                ...
                entryPoint: 'fragment',
                targets: [
                    // Task 4.4: only render to G-Buffer attachments
        ...
        const createGBufferBindGroup = this.device.createBindGroup({
            ...
            entries: [
                ...
                // Task 4.4: remove light source buffer from bindings
            ]
        });
    ...
    async #initDeferredShadingPipeline() {
        // Task 4.4: create a compute pipeline to compute the illumination in our scene in a deferred way
        ...
        // Task 4.4: create the bind group for our deferred shading pass
        ...
        // Task 4.4: store deferred shading pipeline data in helper object
