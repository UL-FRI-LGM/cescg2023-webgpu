{
    ...
    SAMPLES[SAMPLE_NAME] = class extends Sample {
        async load() {
            // Load resources
        ...
        mouse(type, button, x, y) {
            switch (type) {
                case "down": this.dragging = true; break;
                case "up": this.dragging = false; break;
                case "move": break;
                default: return;
            }
        ...
        key(type, key) {
            ...
            switch (key) {
                ...
                case "Q": console.log("Down"); break;
                case "E": console.log("Up"); break;
            }
        }
