...
const SAMPLE_NAME = 'Light Source From Buffer';

export class LightSourceFromBuffer extends Sample {
    async init() {
    ...
    async #initPipelines() {
        // Task 3.1: adapt shader to read light sources from a buffer
        const code = await Loader.loadShaderCode('light-source-from-buffer.wgsl');
