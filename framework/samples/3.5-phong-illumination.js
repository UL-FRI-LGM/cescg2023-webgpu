...
const SAMPLE_NAME = 'PhongIllumination';
...
export class PhongIllumination extends Sample {
    ...
    async #initPipelines() {
        // Task 3.1: adapt shader to compute lighting based on the Phong illumination model
        const code = await Loader.loadShaderCode('phong-illumination.wgsl');
